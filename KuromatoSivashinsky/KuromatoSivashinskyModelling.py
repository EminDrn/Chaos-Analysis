...
def generate_kuramoto_sivashinsky_image(alpha, beta, L, T, N):
...
def main():
    ...
    generate_kuramoto_sivashinsky_image(alpha, beta, L, T, N)
    print("Görsel oluşturuldu ve 'maps' klasörüne kaydedildi.")
